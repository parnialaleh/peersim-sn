 ...
 * distribution. The generated delay has the following properties:
 * <ul>
 * <li>In a given experiment, the latency associated to any pair (source,
 * destination) is fixed </li>
 * <li>In different experiments, the latency generated by a pair (source,
 * destination) may differ.</li>
 * <li>The latency associated to (source,destination) is equal to the latency
 * associated to (destination,source)
 * </ul>
 * 
...
// ---------------------------------------------------------------------
/**
 * Initializes this transport layer by reading the mean and standard deviation.
 */
...
public long getLatency(Node src, Node dest)
{
	...
	element.setSeed(((long) h2) << 32 | h1);
	return (long) normal.nextDouble();
}
